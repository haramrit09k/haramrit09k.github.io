                  ...
                  <div className="row">
                     <div className="columns contact-details download">
                        ...
                        <div className="address">
                           <div><h4 className="contact-heading">Address:</h4>{street}<br />
                              {city} {state}, {zip}
                           </div>
                           <div><h4 className="contact-heading">Phone:</h4>{phone}</div>
                           <div><h4 className="contact-heading">Email:</h4><a href="mailto:haramrit09k@gmail.com">{email}</a></div>
                        </div>
                        <p>
